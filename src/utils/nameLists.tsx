...
export const detectiveNamesMale = ["Sherbloque", "Hermule", "Thilip", "Fancy", "Colombe", "Adrianne",
...
export const detectiveNamesFemale = ["Sherlocke", "Hermula", "Philippa", "Fancy", "Colomba", "Adrianne",
...
export const keywordsMale = ["le vaillant", "l'intrépide", "l'observeur", "le minutieux", "le pro",
...
export const keywordsFemale = ["la vaillante", "l'intrépide", "l'observeuse", "la minutieuse", "la pro",
