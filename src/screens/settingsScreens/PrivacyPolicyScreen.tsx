...
import { View, Text, ScrollView, ImageBackground, Linking } from "react-native";
...
const PrivacyPolicysScreen = ({ }) => {
    ...
    return (
        <ImageBackground source={require('images/bg_corridor_dark.jpg')} style={tw('flex-1')}>
                    ...
                    <View style={tw('mx-auto pt-20 items-center')}>
                        ...
                        <View style={{ ...tw('mb-2 p-6 mx-4 max-w-6xl rounded-lg'), backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
                            ...
                            <Text style={tw('font-primary text-lg')}>
                                ...
                                {"\n\n"}
                                <Text>
                                    <Text style={{ color: 'blue' }} onPress={() => Linking.openURL('mailto:bruno.guillaume@loria.fr')}>
                                        Bruno Guillaume
                                    </Text>
                                    <Text>, LORIA UMR 7503 Campus Scientifique, BP 239 F-54506 Vandœuvre-lès-Nancy Cedex</Text>
                                </Text>, LORIA UMR 7503 Campus Scientifique, BP 239 F-54506 Vandœuvre-lès-Nancy Cedex
                            </Text>
                            ...
                            <Text style={tw('font-primary text-lg')}>
                                Si vous observez des modifications notables dans votre vie quotidienne: syndromes de manque, perte de contrôle par rapport aux jeux, conflits avec vos proches, vous souffrez peut-être d'addiction aux jeux. Nous vous conseillons dans ce cas de contacter Joueurs Info Service.
                                (<Text style={{ color: 'blue' }} onPress={() => Linking.openURL('https://www.joueurs-info-service.fr/')}>
