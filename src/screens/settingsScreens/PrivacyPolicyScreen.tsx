    ...
    return (
        <View style={tw("flex-1 items-center text-black")}>
            <ScrollView style={tw('w-full')}>
                <CustomHeaderEmpty title="Charte d'Admission" />
                <View style={tw('mx-auto min-w-[1200px] pt-20')}>
                    <Text>
                        ...
                        HostoMytho n'est pas à l'abri de bogues et incohérences. Chaque joueur est tenu de rapporter (par mail ou sur le forum) au plus vite tout problème décelé, et toute utilisation abusive ou volontaire d'un bogue ou d'une faille se verra sanctionnée et pourra se solder par la suppression du compte du joueur concerné. Des compensations pourront intervenir de la part des administrateurs, mais ils en seront seuls juges.
                        ...
                        La présente charte doit être lue et acceptée dans son intégralité pour pouvoir jouer à HostoMytho. Elle est susceptible d'être modifiée par les gestionnaires du jeu. Le cas échéant, il sera demandé aux joueurs d'accepter explicitement les modifications apportées pour pouvoir continuer à jouer. Karën Fort et Bruno Guillaume - Administrateurs - Contact : karen point fort at paris-sorbonne point fr et bruno point guillaume at loria point fr | Sources de la charte JDM - SSO - MH - CNIL Dernière mise à jour : janvier 2016
                        En dev</Text>
                </View>
            </ScrollView>
        </View>);
