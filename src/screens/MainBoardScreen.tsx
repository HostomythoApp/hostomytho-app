                    ...
                    <View style={tw("flex-1 items-center")}>
                        ...
                        <View style={StyleSheet.absoluteFill}>
                            <View style={StyleSheet.absoluteFill}>
                                ...
                                {/* Bloc MythoTypo */}
                                <TouchableOpacity
                                    onPress={authState.isAuthenticated && tutorialsCompleted && tutorialsCompleted["MythoNo"] ?
                                        () => navigation.navigate("MythoTypo") :
                                        undefined}
                                    style={{
                                        position: 'absolute',
                                        top: windowWidth > 748 ? '20%' : '20%',
                                        left: windowWidth > 748 ? '43%' : '43%',
                                        opacity: authState.isAuthenticated && tutorialsCompleted && tutorialsCompleted["MythoNo"] ? 1 : 0.6
                                    }}>
                                    <View style={{ position: 'relative' }}>
                                        ...
                                        {/* Icône de notification si MythoNo est terminé, mais MythoTypo ne l'est pas */}
                                        {authState.isAuthenticated && tutorialsCompleted && tutorialsCompleted["MythoNo"] && !tutorialsCompleted["MythoTypo"] && (
                                            <IconNotification size={iconSize} top="2%" right="2%" />
                                        )}

                                        {/* Icône de verrouillage si MythoNo n'est pas terminé ou si non connecté */}
                                        {(!authState.isAuthenticated || !tutorialsCompleted || !tutorialsCompleted["MythoNo"]) && (
                                ...
                                {/* Bloc MythoOuPas */}
                                <TouchableOpacity
                                    onPress={!authState.isAuthenticated || (tutorialsCompleted && tutorialsCompleted["MythoTypo"]) ?
                                        () => navigation.navigate("MythoOuPas") :
                                        undefined}
                                    style={{
                                        position: 'absolute',
                                        ...
                                        opacity: !authState.isAuthenticated || (tutorialsCompleted && tutorialsCompleted["MythoTypo"]) ? 1 : 0.6
                                    }}>
                                    ...
                                    {/* Icône de notification si utilisateur n'est pas connecté ou MythoTypo n'est pas terminé */}
                                    {(!authState.isAuthenticated || (tutorialsCompleted && tutorialsCompleted["MythoTypo"] && !tutorialsCompleted["MythoOuPas"])) && (
                                        <IconNotification size={iconSize} top="1%" right="0%" />
                                    )}

                                    {/* Icône de verrouillage si MythoTypo n'est pas terminé et utilisateur connecté */}
                                    {authState.isAuthenticated && (!tutorialsCompleted || !tutorialsCompleted["MythoTypo"]) && (
                                        <FontAwesome name="lock" size={44} color="slategray" style={{ position: 'absolute', top: '40%', left: '50%', marginTop: -12, marginLeft: -12 }} />
                                    )}
                                </TouchableOpacity>
                                ...
                                {/* Bloc MythoNo */}
                                <TouchableOpacity
                                    onPress={authState.isAuthenticated ? () => navigation.navigate("MythoNo") : undefined}
                                    style={{
                                        position: 'absolute',
                                        top: windowWidth > 748 ? '56%' : '56%',
                                        left: windowWidth > 748 ? '68%' : '68%',
                                        transform: [{ rotate: '-8deg' }],
                                        opacity: authState.isAuthenticated ? 1 : 0.6
                                    }}>
                                    <Image source={require('images/postit_pink.png')}
                                        style={{
                                            width: windowWidth * 0.07, height: windowWidth * 0.07, minWidth: 65, minHeight: 65,
                                        }}
                                        resizeMode="contain"
                                    ...
                                    {/* Icône de notification si utilisateur connecté mais MythoNo non terminé */}
                                    {authState.isAuthenticated && tutorialsCompleted && !tutorialsCompleted["MythoNo"] && (
                                        <IconNotification size={iconSize} top="-5%" right="0%" />
                                    )}

                                    {/* Icône de verrouillage si utilisateur non connecté */}
