...
const UserTypingErrorsStatisticsScreen = ({ }) => {
  ...
  const fetchUserData = async () => {
    try {
      const dailyResult = await getUserTypingErrorsDate();
      const cumulativeResult = await getCumulativeUserTypingErrors();
...
export default UserTypingErrorsStatisticsScreen;
