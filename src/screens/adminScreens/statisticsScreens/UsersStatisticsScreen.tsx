...
import { getUserRegistrationsDate, getCumulativeUserRegistrations } from "services/api/stats";
      ...
      <ScrollView contentContainerStyle={tw("flex-grow justify-center items-center")} style={tw('w-full')}>
        ...
        <View style={tw('mx-auto pt-20 items-center')}>
          <View style={tw('mb-2 p-6 rounded-lg')}>
            ...
            <Text style={tw('text-lg mt-12 mb-4')}>Nombre de créations de comptes par semaine</Text>
            <BarChart
              width={Math.min(Math.max(screenWidth * 0.8, 300), 1200)}
              height={400}
              data={dailyData}
